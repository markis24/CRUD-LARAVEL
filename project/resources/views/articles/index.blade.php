                ...
                <table class="table-fixed w-full">
                    <thead>
                        <tr class="bg-gray-800 text-white">
                            ...
                            <th class="w-1/8 px-2 py-1">RESUMEN ARTICULO</th>
                        </tr>
                    ...
                    <tbody>
                        @foreach ($articles as $article)
                            <tr>
                                ...
                                <td class="w-1/8 px-2 py-1 text-center">{{ $article->title }}</td>
                                <td class="w-1/8 px-2 py-1 text-center">{{ $article->text_article }}</td>
                                <td class=" px-4 py-2">
